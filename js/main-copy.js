document.addEventListener('DOMContentLoaded', () => {
    ...
    const toggle = () => {
        ...
        const checkToggleSiblings = (siblings, container) => {
            siblings === 'true'
        ...
        jsToggles.forEach((jsToggle) => {
            const jsToggleHandler = (event) => {
                ...
                checkToggleSiblings(siblings, container);

                if (currentTarget.classList.contains('active') && container.classList.contains('active')) {
            ...
            jsToggle.addEventListener('click', jsToggleHandler);
        });
    }
